...
## Clinician Summary
For Unspecified governance review question, Sentinel found information sufficiency 0.1 with material gap strength 0.9 and decision weight 0.745. The main driver is: AI-derived decision driver needs verification or downgrade. The most useful next review input is: verify or downgrade AI-derived driver This output is governance review support, not a clinical action recommendation.
