...
## Clinician Summary
For Unspecified governance review question, Sentinel found information sufficiency 0.1 with material gap strength 0.9 and decision weight 0.875. The main driver is: Home-plan feasibility remains unresolved at the decision point. The most useful next review input is: confirm support and return access This output is governance review support, not a clinical action recommendation.
...
- `information_sufficiency`: value `0.1`; Range `0.0` to `0.2`; Median `0.1`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `current_time_information_gaps`; Evidence refs `gap:gap_home_support_001, gap:gap_ai_source_001, gap:gap_response_001`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
...
- `harm_clock`: value `0.9`; Range `0.75` to `1.0`; Median `0.9`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `current_time_information_gaps, therapy_response, ai_provenance`; Evidence refs `gap:gap_home_support_001, gap:gap_ai_source_001, gap:gap_response_001, fact:ai_fact_001, therapy:therapy_supportive_001, therapy_observation:therapy_response_obs_001`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
...
- `recoverability`: value `0.4`; Range `0.25` to `0.55`; Median `0.4`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `current_time_information_gaps, therapy_response`; Evidence refs `gap:gap_home_support_001, gap:gap_ai_source_001, gap:gap_response_001, therapy:therapy_supportive_001, therapy_observation:therapy_response_obs_001`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
- `future_correction_opportunity`: value `0.35`; Range `0.25` to `0.45`; Median `0.35`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `follow_up_feasibility`; Evidence refs `follow_up:synthetic_ed_case_001:T3_disposition_decision`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
- `decision_weight`: value `0.875`; Range `0.725` to `1.0`; Median `0.875`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `current_time_information_gaps, therapy_response, ai_provenance`; Evidence refs `gap:gap_home_support_001, gap:gap_ai_source_001, gap:gap_response_001, fact:ai_fact_001, therapy:therapy_supportive_001, therapy_observation:therapy_response_obs_001`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
- `ai_provenance_risk`: value `0.8`; Range `0.65` to `0.95`; Median `0.8`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `available_facts`; Evidence refs `fact:ai_fact_001`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
- `commission_risk`: value `0.8`; Range `0.65` to `0.95`; Median `0.8`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `proposed_posture, current_time_information_gaps, ai_provenance`; Evidence refs `gap:gap_home_support_001, gap:gap_ai_source_001, gap:gap_response_001, fact:ai_fact_001`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
- `omission_risk`: value `0.9`; Range `0.75` to `1.0`; Median `0.9`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `current_time_information_gaps, follow_up_feasibility, ai_provenance`; Evidence refs `gap:gap_home_support_001, gap:gap_ai_source_001, gap:gap_response_001, fact:ai_fact_001`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
- `therapy_response_relevance`: value `0.75`; Range `0.6` to `0.9`; Median `0.75`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `offered_therapies, therapy_response_observations`; Evidence refs `therapy:therapy_supportive_001, therapy_observation:therapy_response_obs_001`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
- `next_best_information_rank`: value `3`; Range `2.0` to `4.0`; Median `3.0`; Distribution `deterministic_count_with_neighbor_range`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `current_time_information_gaps`; Evidence refs `gap:gap_home_support_001, gap:gap_ai_source_001, gap:gap_response_001`; Sensitivity `Posture sensitivity depends on whether additional gaps cross the materiality threshold.`
- `preventability_opportunity_score`: value `0.7014`; Range `0.6014` to `0.8014`; Median `0.7014`; Distribution `bounded_deterministic_interval`; Method `deterministic_fixture_field_mapping_v0.1`; Dependent inputs `material_gap_strength, decision_weight, information_clock, burden_modifier`; Evidence refs `gap:gap_home_support_001, gap:gap_ai_source_001, gap:gap_response_001`; Sensitivity `Posture sensitivity should be reviewed if the estimate range crosses a graph threshold.`
...
- `evidenceflow:next_best_input` to `next_best_information_rank`: proposed `3`; Range `0.0` to `4.0`; disposition `accepted`; reason `EvidenceFlow candidate normalized with expected posture shift 0.6.`; Evidence refs `synthetic_ed_case_001_candidate_input_001`
- `evidenceflow:next_best_input` to `preventability_opportunity_score`: proposed `0.5`; Range `0.35` to `0.65`; disposition `accepted`; reason `EvidenceFlow candidate normalized with preventability leverage 0.5.`; Evidence refs `synthetic_ed_case_001_candidate_input_001`
